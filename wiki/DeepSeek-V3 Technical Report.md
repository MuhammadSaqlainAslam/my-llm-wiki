...
citation_count: 3500
citation_note: "Curated value from prior manual verification pass (June 2026). Semantic Scholar API returned 429 on re-verification attempt July 2026 — pending fresh fetch on next update-citations run."
